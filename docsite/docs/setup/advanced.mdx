...
<RemoteCodeFile
	title="https://github.com/neurekadev/komodo/blob/main/config/core.config.toml"
	url="https://raw.githubusercontent.com/neurekadev/komodo/main/config/core.config.toml"
	language="toml"
/>
```
