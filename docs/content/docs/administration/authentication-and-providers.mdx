...
3. Set the matching values from the repository's [`compose.env`](https://github.com/neurekadev/komodo/blob/main/compose/compose.env), including the enabled flag, client ID, and client secret.
